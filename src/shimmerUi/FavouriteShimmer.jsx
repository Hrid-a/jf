    ...
    return (
        ...
        <section className="">
            ...
            <article className="flex items-center  rounded-lg gap-3 overflow-x-auto  scrollbar-none  mb-14">
                {[...Array(3)].map((item, index)=> <div key={index} className="group min-w-[250px] h-[300px] rounded-lg relative overflow-hidden cursor-pointer   before:absolute bg-gray-400 inset-0 z-10">
