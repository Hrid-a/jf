        ...
        <div className="mt-20">
            <section className="">
                ...
                <article className="flex items-center  rounded-lg gap-3 overflow-x-auto  scrollbar-none  mb-14">
                    {[...Array(7)].map((item, index) => <div key={index} className="group min-w-[250px] h-[300px] rounded-lg relative overflow-hidden cursor-pointer   before:absolute skeleton inset-0 z-10">
            ...
            <section className="mt-10">
                <div className="skeleton h-7 w-36 my-10 rounded-lg"></div>
                <article className="flex items-center gap-3 rounded-lg  overflow-x-auto scrollbar-none  mb-14">
                    {[...Array(7)].map((item, index) => <div key={index} className="group min-w-[250px] h-[300px] rounded-lg relative overflow-hidden cursor-pointer   before:absolute skeleton inset-0 z-10">
                        <div className="h-full w-full rounded-lg  skeleton" ></div>
                        <h4 className="absolute left-2 rounded-lg  bottom-1  h-7 w-36 skeleton"></h4>
